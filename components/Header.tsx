      ...
      <div className="md:hidden">
        <div className="flex items-center justify-between backdrop-blur-xl bg-[#2a2520]/95 rounded-2xl px-5 py-3 shadow-lg border border-[#e89a7a]/10">
          ...
          <details className="relative">
            ...
            <div className="absolute right-0 top-12 min-w-48 backdrop-blur-xl bg-[#2a2520]/98 rounded-2xl shadow-xl border border-[#e89a7a]/10 overflow-hidden">
              <div className="py-2">
                <Link
                  href="/"
                ...
                <div className="border-t border-[#e89a7a]/10 my-2" />
