...
export default async function Phase3Page() {
  ...
  return (
    <div className="relative min-h-dvh overflow-hidden bg-gradient-to-br from-[#faf8f5] via-[#faf4ed] to-[#f5ede3] flex items-center justify-center">
      <div className="hidden md:block pointer-events-none absolute inset-0 -z-10">
        <div className="absolute top-1/4 left-1/4 h-96 w-96 rounded-full bg-[#7a9b88]/8 blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 h-[32rem] w-[32rem] rounded-full bg-[#d97757]/6 blur-3xl" />
      </div>

      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        <div className="mb-8">
          <div className="inline-flex h-20 w-20 items-center justify-center rounded-2xl bg-[#7a9b88]/10 text-[#7a9b88] mb-6">
            <Palette className="h-10 w-10" />
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold text-[#2a2520] mb-3">
            Phase 3 – Gestalten
          </h1>
          <p className="text-lg text-[#6b635a]">
