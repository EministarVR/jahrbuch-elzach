      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-full bg-[#e89a7a]/10 border border-[#e89a7a]/20">
            <BookOpen className="h-4 w-4 text-[#e89a7a]" />
            ...
            <TiltCard>
              <GlassCard hover>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-xl bg-[#8faf9d]/10 flex items-center justify-center">
                      <Info className="h-5 w-5 text-[#8faf9d]" />
                    </div>
                    <h3 className="font-semibold text-[#f5f1ed]">Hinweise</h3>
                  </div>
                  <ul className="space-y-2 text-sm text-[#b8aea5]">
                    <li className="flex gap-2">
                      <span className="text-[#e89a7a]">•</span>
            ...
            <MotionFade delay={0.1}>
              <GlassCard hover>
                <div className="space-y-3">
                  <h3 className="font-semibold text-[#f5f1ed]">Datenschutz</h3>
                  <p className="text-sm text-[#b8aea5]">
                    Deine Daten sind sicher. Wir verwenden keine Tracking-Cookies.
                  </p>
                  <Link
                    href="/datenschutz"
                    className="inline-flex items-center gap-1 text-sm text-[#e89a7a] hover:underline"
                  >
                    Mehr erfahren →
                  </Link>
                </div>
