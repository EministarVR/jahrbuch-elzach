  ...
  return (
    <footer className="relative mt-12">
      ...
      <div className="mx-auto max-w-6xl px-4 pb-10">
        <div className="rounded-3xl ring-1 ring-slate-200/90 dark:ring-slate-700/90 md:ring-black/5 md:dark:ring-white/10 bg-white dark:bg-slate-900 bg-[linear-gradient(145deg,rgba(255,255,255,0.98),rgba(245,247,255,0.92))] dark:bg-[linear-gradient(145deg,rgba(36,45,63,0.95),rgba(28,36,52,0.85))] md:bg-white/60 md:dark:bg-slate-900/50 md:backdrop-blur-sm overflow-hidden">
          {/* Decorative strip */}
