          ...
          {[
            ...
            <GlassCard key={item.title} delay={i * 0.1}>
              <div className="text-center space-y-4">
                ...
                <h3 className="font-semibold text-xl text-[#f5f1ed]">
                  {item.title}
                </h3>
                <p className="text-[#b8aea5] leading-relaxed">
                  {item.text}
                </p>
              </div>
            </GlassCard>
          ...
          <div className="text-center space-y-8 py-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto pt-8">
              <div className="flex items-start gap-4 text-left">
                <div className="w-10 h-10 rounded-xl bg-[#8faf9d]/15 flex items-center justify-center text-[#8faf9d] flex-shrink-0">
                  <ThumbsUp className="h-5 w-5" />
                </div>
                <div>
                  <h3 className="font-semibold text-[#f5f1ed] mb-1">
                    Abstimmen
                  </h3>
              ...
              <div className="flex items-start gap-4 text-left">
                <div className="w-10 h-10 rounded-xl bg-[#e89a7a]/15 flex items-center justify-center text-[#e89a7a] flex-shrink-0">
            ...
            <GlassCard delay={0} hover>
              <div className="space-y-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-[#e89a7a] uppercase tracking-wider mb-1">
                      Phase 1
                    </div>
                ...
                {phase1?.status === 'development' ? (
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#ffb74d]/10 border border-[#ffb74d]/20">
                    <Wrench className="h-3 w-3 text-[#ffb74d]" />
                    <span className="text-xs font-medium text-[#ffb74d]">
                      In Entwicklung
                    </span>
                  </div>
                ) : phase1?.enabled ? (
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#8faf9d]/15 border border-[#8faf9d]/20">
                    <div className="w-2 h-2 bg-[#8faf9d] rounded-full animate-pulse" />
                    <span className="text-xs font-medium text-[#8faf9d]">
                      Jetzt aktiv
                    </span>
                  </div>
                ) : (
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#b8aea5]/10 border border-[#b8aea5]/15">
                    <span className="text-xs font-medium text-[#b8aea5]">
            ...
            <GlassCard delay={0.1} hover>
              <div className="space-y-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-[#c9a68a] uppercase tracking-wider mb-1">
                      Phase 2
                    </div>
                    <h3 className="text-xl font-bold text-[#f5f1ed]">
                      Abstimmen
            ...
            <GlassCard delay={0.2} hover>
              <div className="space-y-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-[#8faf9d] uppercase tracking-wider mb-1">
                      Phase 3
                    </div>
                    <h3 className="text-xl font-bold text-[#f5f1ed]">
                      Fertigstellen
