...
export default function GlassCard({
  ...
  const content = (
    ...
    >
      <div
        className={clsx(
          "relative rounded-[var(--radius-xl)] overflow-hidden has-sheen",
          "bg-[linear-gradient(145deg,rgba(255,255,255,0.87),rgba(255,255,255,0.62))] dark:bg-[linear-gradient(145deg,rgba(36,45,63,0.85),rgba(28,36,52,0.72))]",
